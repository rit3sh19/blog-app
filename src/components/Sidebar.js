...
export default function Sidebar({ children }) {
  ...
  return (
    <aside className="h-">
      <nav className="h-full flex flex-col bg-black text-white border-r border-gray-800 shadow-sm">
        ...
        <div className="border-t flex p-3">
          ...
          >
            <div className="leading-4">
              <h4 className="font-semibold">Ritesh M H</h4>
      ...
      className={`relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group
        ${
          active
            ...
            : "hover:bg-indigo-50 dark:hover:bg-gray-800 text-gray-700 dark:text-white/70"
        }`}
    >
      {icon}
      <span
